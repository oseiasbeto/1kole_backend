...
const session = new mongoose.Schema(
    {
        ...
        id: {
            type: String,
            default: () => `${Date.now()}`, // O ID é baseado no timestamp para garantir unicidade
        },
        ...
        // Tipo de sessão, como "login", "2FA" (autenticação de dois fatores), "oauth", etc.
        sessionType: {
            type: String,
            default: "login", // Definido como "login" por padrão, mas pode ser alterado conforme o tipo de autenticação
        },
